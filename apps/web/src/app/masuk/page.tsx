      ...
      <div className="mt-8 rounded-2xl border border-[var(--line)] bg-[var(--panel)] p-6 shadow-xl space-y-5">
        ...
        <div className="relative border-t border-[var(--line)] pt-4 text-center">
          ...
          <button
            ...
            className="mt-2 w-full rounded-lg border border-[var(--line)] bg-[var(--bg)] px-4 py-2.5 text-xs font-semibold text-white hover:border-slate-500 transition flex items-center justify-center gap-2"
          >
        ...
        <div className="border-t border-[var(--line)] pt-4 text-center text-xs text-[var(--muted)]">
          Belum memiliki akun?{" "}
          <Link href="/daftar" className="text-red-400 font-semibold hover:text-red-300">
            Daftar di sini
          </Link>
        </div>
      </div>
